...
meta_land <- read.table("~/Documents/UCSC_postdoc/river_herring/data/blueback_herring/landlocked_metadata.txt")
# meta_base <- read.delim("~/Documents/UCSC_postdoc/river_herring/data/blueback_herring/baseline_metadata.txt", header = TRUE)
...
ale_base_latlon <- read.delim("~/Documents/UCSC_postdoc/river_herring/data/alewife/ALE_anadromous_latlon.txt", header = TRUE, fileEncoding="latin1")
ale_land_latlon <- read.delim("~/Documents/UCSC_postdoc/river_herring/data/alewife/ALE_landlocked_latlon.txt", header = TRUE)
...
us_rivers <- readOGR("~/Documents/UCSC_postdoc/river_herring/maps/ne_10m_rivers_lake_centerlines/ne_10m_rivers_lake_centerlines.shp")
us_rivers_fine <- readOGR("~/Documents/UCSC_postdoc/river_herring/maps/ne_10m_rivers_north_america/ne_10m_rivers_north_america.shp")
H_0602Lakes <- readOGR("~/Documents/UCSC_postdoc/river_herring/maps/H_0602_lakes/H_0602_lakes.shp")
H_0306Lakes <- readOGR("~/Documents/UCSC_postdoc/river_herring/maps/H_0306_lakes/H_0306_lakes.shp")
H_0313Lakes <- readOGR("~/Documents/UCSC_postdoc/river_herring/maps/H_0313_lakes/H_0313_lakes.shp")
H_0315Lakes <- readOGR("~/Documents/UCSC_postdoc/river_herring/maps/H_0315_lakes/H_0315.shp")
H_0307Lakes <- readOGR("~/Documents/UCSC_postdoc/river_herring/maps/H_0307_lakes/H_0307.shp")
H_0305Lakes <- readOGR("~/Documents/UCSC_postdoc/river_herring/maps/H_0305_lakes/H_0305.shp")
H_0601Lakes <- readOGR("~/Documents/UCSC_postdoc/river_herring/maps/H_0601_lakes/H_0601.shp")
...
#### Large map ####
png(file="~/Documents/UCSC_postdoc/river_herring/maps/anadromous.png", width=9, height=7.5, res=300, units="in")
...
png(file="~/Documents/UCSC_postdoc/river_herring/maps/landlocked.png", width=7, height=5, res=300, units="in")
...
png(file="~/Documents/UCSC_postdoc/river_herring/maps/li_sound.png", width=7, height=5, res=300, units="in")
